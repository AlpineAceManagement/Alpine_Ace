...
- **port:** Standartmässig wird der Port 5432 verwendet

Die Informationen werden an verschieden Orten im Programm Code verwendet. Dafür wurde für Python und JS jeweills ein Config File erstellt, in welcher die Verbindungsinformationen angeben sind:
...
Das Datenbankschema ist in folgende Gruppen eingetielt:

- **Skigebiet:** Das Skigebiet ist mit sehr vielen Tabellen verknüpft.
- **Meteodaten:** Beinhaltet Informationen Wetterprognose, Schnehöhen, Messdaten
- **Sicherheitsinformationen:** Verfügt über die akutelle Lawinienbulletine
...
- **api/saison_total** Die wichtigsten Kennzahlen der Skidaten pro Sasion wie die Summe der Höhenmeter, Distanz sowie der Durchschnitt der Distanz, Geschwindigkeit und die Maximale Geschwindigkeit.
- **/api/prognos** Die Akutellesten Informationen der Tabelle Prognose
- **/api/schneehoehe** Die Akutellesten Informationen der Tabelle Schneehoehe von der Station ROT3
- **/api/messdaten** Die Akutellesten Informationen der Tabelle Messdaten
- **/api/bulletins** Die Akutellesten Informationen der Lawinengefahr in der Lenzerheide
