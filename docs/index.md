...
<iframe src="videos/AlpineACE_addvert3_hd.mov" style="width: 100%; height: auto; border: none;" allowfullscreen></iframe>
...
- [Alpine Ace - Ski App](#alpine-ace---ski-app)
  ...
  - [Incoming Features](#incoming-features)
    ...
    - [Status Pisten und Analgen](#status-pisten-und-analgen)
...
<table style="border-collapse: collapse; width: 100%;">
    ...
    <tr>
        ...
        <td style="border: none;"><center><img src="images/app-navi.jpg" style="max-height: 78s%; width: 78%;" /></center></td>
    </tr>
    <tr>
...
Das DHM25 ist das digitale Höhenmodell der [Swisstopo](https://www.swisstopo.admin.ch/) mit einer Auflösung von 25 Meter.

- **Datenursprung**: Datei `DHM25_MM_ASCII_GRID.zip` von der [Swisstopo](https://www.swisstopo.admin.ch/de/hoehenmodell-dhm25).
- **Datenstand**: Datum Download
...
<table style="border-collapse: collapse; width: 100%;">
  <tr>
    ...
    <td style="text-align: center;">
      <img src="images/karte_legende.png" alt="Karte mit Legende" style="max-width: 50%; max-height: 50%;">
    </td>
    <td></td>
  </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%;">
  <tr>
    <td></td>
    <td style="text-align: center;">
      <img src="images/Auswahl_Skigebiet.png" alt="Auswahl des Skigebietes" style="max-width: 50%; max-height: 50%;">
    </td>
    <td></td>
  </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%;">
  <tr>
    <td></td>
    <td style="text-align: center;">
      <img src="images/Bewertungen.png" alt="Bewertung Restaurant" style="max-width: 50%; max-height: 50%;">
    </td>
    <td></td>
  </tr>
</table>
...
<table style="border-collapse: collapse; width: 100%;">
  <tr>
    <td></td>
    <td style="text-align: center;">
      <img src="images/einstellungen.png" alt="Einstellungen des Profiles" style="max-width: 50%; max-height: 50%;">
    </td>
    <td></td>
  </tr>
</table>
