...
const Wetter = () => {
  ...
  const temp = [{"hour": 0, "temperature": 10},
...
const PrognosisChart = ({ data }) => {
  ...
  return (
    <Vega spec={vegaSpec} data={{ table: data }} />
  );
};
          ...
          {weatherData && (
            <Box
              sx={{
                ...
                <WeatherDataItem label="Temperatur (C°)" value={parseFloat(weatherData.md_temperatur).toFixed(1)} />
                <WeatherDataItem label="Wetter" value={weatherData.md_wetter}/>
                <WeatherDataItem label="Windgeschwindigkeit [km/h]" value={parseFloat(weatherData.md_windgeschwindigkeit).toFixed(1)} />
          ...
          {snowData &&(
            <Box
              sx={{
                ...
                <WeatherDataItem label= "Schneehöhe [cm]" value={parseFloat(snowData.sh_hoehe).toFixed(1)} />
            </Box>
          )}
